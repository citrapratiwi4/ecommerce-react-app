    ...
    <div className="bg-white min-h-screen text-gray-800">
      ...
      <section className="pt-16 md:pt-20 pb-10 md:pb-12 text-center max-w-xl mx-auto px-6">
        ...
        <h3 className="text-xl md:text-3xl font-light leading-relaxed text-gray-900">
          Designed with simplicity, shaped by elegance, and made to last beyond
          seasons.
        </h3>
      </section>
      ...
      <section id="catalog" className="py-10 md:py-12">
        <div className="max-w-[1400px] mx-auto px-2 md:px-5">
          <div className="text-center mb-8">
            <h3 className="text-xl md:text-3xl font-light tracking-wide mb-4">
              New Collection
            </h3>
                ...
                <div key={item.id} className="group relative">
                  ...
                  >
                    <svg
                      ...
                      strokeWidth="1.5"
                      className="w-4 h-4 md:w-6 md:h-6 transition"
                    >
                      <path
                        strokeLinecap="round"
                  ...
                  <Link to={`/product/${item.id}`} className="block">
                    <div className="relative w-full aspect-[4/5] md:h-[450px] overflow-hidden bg-gray-100">
                      ...
                      <img
                        ...
                        alt={item.name}
                        className="absolute inset-0 w-full h-full object-cover opacity-0 transition-all duration-700 ease-in-out md:group-hover:opacity-100 md:group-hover:scale-105"
                      />
                    </div>

                    <div className="mt-3 md:mt-5 space-y-1 md:space-y-2 text-center px-1">
                      <h4 className="text-[10px] md:text-xs font-medium tracking-[0.1em] md:tracking-[0.15em] uppercase text-gray-800 truncate">
                        {item.name}
                      </h4>
      ...
      <section className="py-14 md:py-28 bg-white">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="relative w-full max-w-[700px] mx-auto">
            <img
              src={vestbiru}
              alt="Blazer Collection Preview"
              className="w-full h-auto object-contain"
            />
          </div>
          <div className="max-w-md flex flex-col items-start px-2 md:px-0">
            <p className="text-[10px] md:text-sm font-medium tracking-[0.2em] text-gray-400 uppercase mb-1 md:mb-2">
              Coming Soon
            </p>
            ...
            <div className="flex flex-col items-start">
              ...
              <Link
                to="/category/blazer"
                className="inline-block border border-black px-6 py-2.5 md:px-10 md:py-4 text-[9px] md:text-[10px] font-medium tracking-[0.2em] uppercase hover:bg-black hover:text-white transition duration-300"
              >
                Preview Collection
              </Link>
            </div>
      ...
      <section className="py-10 md:py-24 bg-white">
        <div className="max-w-[1400px] mx-auto px-4 md:px-12">
          <div className="text-center mb-8 md:mb-16">
            <p className="text-[10px] md:text-xs tracking-[0.3em] uppercase text-gray-400 mb-2 md:mb-4">
              Explore
            </p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8">
            {[
              ...
              <Link
                ...
                className="group relative overflow-hidden h-[180px] sm:h-[250px] md:h-[420px]"
              >
                <img
                  src={cat.image}
                  alt={cat.name}
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <h4 className="text-white text-xs md:text-xl tracking-[0.2em] uppercase font-light">
                    {cat.name}
                  </h4>
                </div>
              </Link>
