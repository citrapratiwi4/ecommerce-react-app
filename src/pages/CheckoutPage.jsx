...
function CheckoutPage({
  ...
  const shippingOptions = [
    {
      id: "jne-reg",
      name: "JNE Express - REG",
      time: "4 to 5 business days",
      price: 59000,
    },
    {
      id: "sap-reg",
      name: "SAP Express - UDRREG",
      time: "2 to 5 business days",
      price: 59000,
    },
    {
      id: "sap-ons",
      name: "SAP Express - UDRONS",
      time: "1 business day",
      price: 73000,
    },
    {
      id: "jne-jtr",
      name: "JNE Express - JTR",
      time: "6 to 7 business days",
      price: 160000,
    },
  ];
  ...
  const handleApplyDiscount = (e) => {
    ...
    if (code === "ELANORA20") {
      ...
      setDiscountMessage({
        text: "Promo berhasil diterapkan! Anda berhemat 20%.",
        type: "success",
      });
    } else {
      setLocalDiscount(0);
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        ...
        <button
          onClick={() => navigate("/")}
          className="bg-black text-white px-8 py-3 text-[10px] tracking-[0.2em] uppercase hover:bg-gray-800 transition"
        >
          Kembali Belanja
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-[#333333]">
      <header className="w-full bg-white border-b border-gray-200 px-6 py-6 lg:px-16 xl:px-24 flex justify-between items-center z-10">
        ...
        <Link
          to="/cart"
          className="relative text-black hover:text-gray-500 transition flex items-center"
        >
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      <div className="flex flex-col-reverse lg:flex-row flex-1">
        <div className="w-full lg:w-[55%] xl:w-[55%] bg-white px-6 py-8 lg:px-16 xl:px-24 border-r border-gray-200">
          ...
          >
            ...
            <section>
              ...
              <div className="space-y-3.5">
                ...
                <div className="flex gap-3.5">
                  ...
                  <input
                    type="text"
                    placeholder="City / Regency (Kota/Kabupaten)"
                    required
                    value={city}
            ...
            <section>
              <div className="flex justify-between items-end mb-4">
                <h2
                  className={`text-xl font-normal ${shippingError ? "text-red-500" : "text-gray-900"}`}
                >
                  Shipping method
                </h2>
                {shippingError && (
              ...
              >
                ...
                >
                  <span
                    className={`text-sm ${selectedShipping ? "text-gray-900 font-medium" : "text-gray-500"}`}
                  >
                    {selectedShipping
                  ...
                  <svg
                    className={`w-4 h-4 text-gray-500 transition-transform duration-300 ${showShippingOptions ? "rotate-180" : ""}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                {showShippingOptions && (
                  <div className="bg-[#fafafa] animate-fade-in">
                    {shippingOptions.map((option, index) => (
                      <label
                        key={option.id}
                        className={`flex items-start p-4 cursor-pointer transition ${index !== shippingOptions.length - 1 ? "border-b border-gray-200" : ""} ${selectedShipping === option.id ? "bg-white" : "hover:bg-white/50"}`}
                      >
              ...
              <div className="border border-gray-300 rounded-md overflow-hidden">
                ...
                <div className="p-6 bg-[#fafafa] border-t border-gray-200 text-center">
                  <p className="text-[13px] text-gray-500 leading-relaxed max-w-[320px] mx-auto">
                    You will be redirected to Payments via Midtrans to complete
            ...
            <section>
              ...
              <div className="border border-gray-300 rounded-lg overflow-hidden">
                ...
                <div
                  className={`flex items-center p-4 cursor-pointer transition ${useDifferentBilling ? "bg-gray-50" : "bg-white"}`}
        ...
        <div className="w-full lg:w-[45%] xl:w-[45%] bg-[#fafafa] px-6 py-8 lg:px-12 xl:px-16 border-b lg:border-b-0 border-gray-200">
          ...
          <div
            className={`${isOrderSummaryOpen ? "block" : "hidden"} lg:block transition-all duration-300`}
          >
            ...
            <div className="py-6 border-y border-gray-200 mb-6">
              ...
              {!appliedDiscountCode && !discountMessage.text && (
                <p className="text-[10px] text-gray-400 mt-2 tracking-wide">
                  Use code{" "}
                  <span className="font-semibold text-gray-800">ELANORA20</span>{" "}
              ...
              {discountMessage.text && (
                <p
                  className={`text-xs mt-3 ${discountMessage.type === "success" ? "text-green-600 font-medium" : "text-red-500"}`}
                >
                  {discountMessage.text}
                </p>
              )}
              ...
              {localDiscount > 0 && (
                <div className="flex justify-between items-center text-green-600 animate-fade-in">
                  ...
                  <span className="font-medium">
                    -Rp {localDiscount.toLocaleString("id-ID")}
                  </span>
                </div>
              )}
