...
function ProductDetail({ wishlist, toggleWishlist, addToCart, cart, setIsCartOpen }) {
  const { id } = useParams();
  ...
  const availableSizes = 
    ...
    product.sizes || 
    (product.category.toLowerCase() === "footwear" ? ["36", "37", "38", "39", "40"] : ["S", "M", "L", "XL"]);
          ...
          <div className="w-full lg:w-[420px] shrink-0 sticky top-32 mt-4 md:mt-0">
            ...
            {hasVariants && (
              <div className="mb-6 md:mb-8">
                <p className="text-xs md:text-sm text-gray-700 mb-3">
                  Variants: <span className="font-medium text-black uppercase">{selectedVariant?.name}</span>
                </p>
              ...
              <div className="mb-8">
                <div className="flex items-center gap-6 mb-3">
                  <p className="text-xs md:text-sm">
                    Size: <span className="font-medium">{selectedSize || "Select Size"}</span>
                  </p>
            ...
            <div className="mt-8 md:mt-10 border-t border-gray-200">
              <div className="border-b border-gray-200">
                <button onClick={() => toggleAccordion("description")} className="w-full flex justify-between items-center py-4 md:py-5 text-[11px] md:text-xs tracking-[0.2em] uppercase text-gray-800 hover:text-black transition">
                  Description <span className="text-lg">{openAccordion === "description" ? "−" : "+"}</span>
                </button>
                <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openAccordion === "description" ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`}>
                  <div className="pb-5 md:pb-6 text-[13px] md:text-sm text-gray-500 leading-relaxed md:leading-7">
                    {product.shortDescription || "Crafted with timeless elegance and premium quality fabric, designed to transition effortlessly from day to evening wear."}
                  </div>
                </div>
              </div>

              <div className="border-b border-gray-200">
                <button onClick={() => toggleAccordion("materials")} className="w-full flex justify-between items-center py-4 md:py-5 text-[11px] md:text-xs tracking-[0.2em] uppercase text-gray-800 hover:text-black transition">
                  Materials & Care <span className="text-lg">{openAccordion === "materials" ? "−" : "+"}</span>
                </button>
                <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openAccordion === "materials" ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`}>
                  <div className="pb-5 md:pb-6 text-[13px] md:text-sm text-gray-500 space-y-2 leading-relaxed md:leading-7">
                    <p><span className="font-medium text-gray-700">Material:</span> {product.materials || "Premium blended fabrics."}</p>
                    <p><span className="font-medium text-gray-700">Care:</span> {product.care || "Dry clean only. Do not bleach."}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 md:mt-8 space-y-2 md:space-y-3 text-xs md:text-sm text-gray-600">
              <p className="flex items-center gap-2"><span className="text-black">✓</span> Free shipping over Rp 500.000</p>
              <p className="flex items-center gap-2"><span className="text-black">✓</span> 7 days easy return</p>
            </div>
          </div>
        </div>
        ...
        <div id="reviews" className="mt-20 md:mt-32 pt-12 md:pt-16 border-t border-gray-200 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-12 md:mb-16">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <p className="text-xs md:text-sm text-gray-500 font-light">Based on {product.reviewsCount || 124} reviews</p>
            </div>
          </div>
          ...
          <div className="space-y-8 md:space-y-10">
            <div className="border-b border-gray-100 pb-6 md:pb-8">
              <div className="flex justify-between items-start mb-3 md:mb-4">
                <div>
                  <div className="flex text-yellow-400 text-[10px] md:text-xs tracking-widest mb-1 md:mb-2">★★★★★</div>
                  <p className="text-xs md:text-sm font-medium text-black">Beautiful and elegant!</p>
                </div>
                <span className="text-[10px] md:text-xs text-gray-400">2 days ago</span>
              </div>
              <p className="text-xs md:text-sm text-gray-600 font-light mb-3 md:mb-4 leading-relaxed">The material feels very premium and the fit is perfect. It looks exactly like the pictures. Definitely worth the price for such a timeless piece.</p>
              <p className="text-[10px] md:text-xs text-gray-400 italic">Jane D. - Verified Buyer</p>
            </div>
            ...
            <div className="border-b border-gray-100 pb-6 md:pb-8">
              <div className="flex justify-between items-start mb-3 md:mb-4">
                <div>
                  <div className="flex text-yellow-400 text-[10px] md:text-xs tracking-widest mb-1 md:mb-2">★★★★★</div>
                  <p className="text-xs md:text-sm font-medium text-black">In love with this!</p>
                </div>
                <span className="text-[10px] md:text-xs text-gray-400">1 week ago</span>
              </div>
              <p className="text-xs md:text-sm text-gray-600 font-light mb-3 md:mb-4 leading-relaxed">Wore this to a dinner party and got so many compliments. The silhouette is very flattering. Highly recommend adding this to your wardrobe!</p>
              <p className="text-[10px] md:text-xs text-gray-400 italic">Sarah M. - Verified Buyer</p>
            </div>
          </div>
      ...
      <section className="py-20 md:py-32 border-t border-gray-50 text-center">
        <div className="max-w-xl mx-auto px-6">
          ...
          <h3 className="text-base md:text-2xl font-light leading-relaxed text-gray-900 mb-8 md:mb-12 px-2">
            Every piece is designed to transcend trends, delivering enduring quality that lasts beyond the seasons.
          </h3>
      ...
      <footer className="bg-white border-t border-gray-200 py-16 md:py-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12 mb-12 md:mb-16 text-center md:text-left">
            <div>
              <h4 className="text-lg md:text-xl font-medium tracking-[0.15em] uppercase mb-4 md:mb-6">Élanora</h4>
              <p className="text-xs md:text-sm text-gray-500 leading-relaxed">Timeless silhouettes designed with simplicity, shaped by elegance, and crafted to last.</p>
            </div>
            <div>
              <h5 className="text-[10px] md:text-xs tracking-[0.25em] uppercase text-gray-400 mb-4 md:mb-6">Shop</h5>
              <ul className="space-y-3 text-xs md:text-sm text-gray-600">
                <li><Link to="/category/dress" className="hover:text-black">Dress</Link></li>
                <li><Link to="/category/skirt" className="hover:text-black">Skirt</Link></li>
                <li><Link to="/category/blazer" className="hover:text-black">Blazer</Link></li>
                <li><Link to="/category/footwear" className="hover:text-black">Footwear</Link></li>
              </ul>
            </div>
            <div>
              <h5 className="text-[10px] md:text-xs tracking-[0.25em] uppercase text-gray-400 mb-4 md:mb-6">Customer Care</h5>
              <ul className="space-y-3 text-xs md:text-sm text-gray-600">
            ...
            <div>
              <h5 className="text-[10px] md:text-xs tracking-[0.25em] uppercase text-gray-400 mb-4 md:mb-6">Follow</h5>
              <ul className="space-y-3 text-xs md:text-sm text-gray-600">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm transition-opacity duration-300">
          <div className="bg-white w-full max-w-2xl p-6 md:p-12 relative shadow-2xl">
            ...
            <div className="text-center mb-6 md:mb-8">
              <h3 className="text-xl md:text-2xl font-light tracking-wide text-gray-900 mb-1 md:mb-2">Size Guide</h3>
              <p className="text-[10px] md:text-xs text-gray-500 font-light tracking-widest uppercase">Measurements in Centimeters (cm)</p>
            </div>
            ...
            <div className="overflow-x-auto">
              {product.category.toLowerCase() === "footwear" ? (
                <table className="w-full text-xs md:text-sm text-center border-collapse">
                  <thead>
                    <tr className="bg-gray-50 text-gray-800 uppercase tracking-widest text-[9px] md:text-[10px]">
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Size (EU)</th>
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">US Size</th>
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Foot Length (cm)</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-600 font-light">
                    {[
                      ...
                      <tr key={i} className="border-b border-gray-100 hover:bg-gray-50 transition">
                        <td className="py-3 md:py-4 font-medium text-black">{row.eu}</td>
                ...
                <table className="w-full text-xs md:text-sm text-center border-collapse">
                  <thead>
                    <tr className="bg-gray-50 text-gray-800 uppercase tracking-widest text-[9px] md:text-[10px]">
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Size</th>
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Waist</th>
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Hip</th>
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Length</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-600 font-light">
                    {[
                      ...
                      <tr key={i} className="border-b border-gray-100 hover:bg-gray-50 transition">
                        <td className="py-3 md:py-4 font-medium text-black">{row.size}</td>
                ...
                <table className="w-full text-xs md:text-sm text-center border-collapse">
                  <thead>
                    <tr className="bg-gray-50 text-gray-800 uppercase tracking-widest text-[9px] md:text-[10px]">
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Size</th>
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Bust</th>
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Waist</th>
                      <th className="py-3 md:py-4 border-b border-gray-200 font-medium">Hip</th>
                    </tr>
                  </thead>
            ...
            <div className="mt-6 md:mt-8 text-[10px] md:text-[11px] text-gray-400 font-light text-center leading-relaxed">
              Please note that these measurements are a general guide. <br className="hidden md:block"/> Fits may vary by style or personal preference.
            </div>
          </div>
        </div>
      )}
